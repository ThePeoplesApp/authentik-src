# Change Log (NEVER DELETE; ALWAYS APPEND)
<!-- New entries: always add at the TOP of this file. Confirm Date -->
<!-- For a NEW day, add a new `## YYYY-MM-DD` heading at the very top, then list entries newest time first. -->
